...
Originally, this was developed as [requests](https://github.com/jossef/requests).

In order to speed-up further development, a new version was created that has **Sound Null Safety** and various other fixes.

Additionally, we are adding streamed download & upload as well as file-based download & upload, which allows for large downloads/uploads on mobile devices with their limited RAMs.
